...
# {name} ve {bio} yer tutucuları kişiye özel doldurulur. Her creator'a diline
# uygun varyantlardan RASTGELE biri atanır -> sürekli aynı metin gitmez.
TEMPLATES = {
    "tr": [
        ("Selam {name} \U0001F44B\n\n16 ya\u015f\u0131nday\u0131m ve senin de ya\u015fad\u0131\u011f\u0131n bir "
         ...
         "Bir dene, i\u015fine yarad\u0131 m\u0131 d\u00fcr\u00fcst\u00e7e s\u00f6yle. Link: thecaptionai.com \U0001F680"),
        ("Merhaba {name} \u2728\nSenin gibi d\u00fczenli payla\u015fan birine sormak istedim: caption yazmak "
         ...
         "\u00dccretsiz dene, ne d\u00fc\u015f\u00fcnd\u00fc\u011f\u00fcn\u00fc merak ediyorum: thecaptionai.com"),
        ("Selam {name}! \U0001F525\nH\u0131zl\u0131 olaca\u011f\u0131m: videolar\u0131n\u0131 g\u00f6rd\u00fcm, i\u00e7erik g\u00fczel ama "
         ...
         "CaptionAI'yi yapt\u0131m: 3 saniyede hook'lu caption + hashtag. Bir dene, geri bildirimin benim "
         "i\u00e7in \u00e7ok de\u011ferli: thecaptionai.com"),
    ],
    "en": [
        ("Hey {name} \U0001F44B\nI'm 16 and built this because of something you've probably felt: the "
         ...
         "Give it a try and tell me honestly if it helped. Link: thecaptionai.com \U0001F680"),
        ("Hi {name} \u2728\nQuick one for someone who posts consistently: isn't writing captions the worst "
         ...
         "captions + hashtags. Free to try, I'd love your honest take: thecaptionai.com"),
        ("Hey {name}! \U0001F525\nStraight up: your content is good but punchier captions would get you more "
         ...
         "Try it, your feedback means a lot: thecaptionai.com"),
    ],
    "es": [
        ("Hola {name} \U0001F44B\nTengo 16 a\u00f1os y cre\u00e9 esto por algo que seguro te pasa: el video est\u00e1 "
         ...
         "tienes 4 captions con ganchos fuertes + hashtags. Pru\u00e9balo y dime si te sirvi\u00f3: thecaptionai.com \U0001F680"),
        ("Hola {name} \u2728\nUna pregunta r\u00e1pida para alguien que publica seguido: \u00bfno odias escribir los "
         ...
         "con f\u00f3rmula viral + hashtags. Gratis, me encantar\u00eda tu opini\u00f3n: thecaptionai.com"),
        ("\u00a1Hola {name}! \U0001F525\nDirecto: tu contenido es bueno pero captions m\u00e1s potentes te dar\u00edan m\u00e1s "
         ...
         "Pru\u00e9balo, tu feedback vale mucho: thecaptionai.com"),
    ],
    "de": [
        ("Hey {name} \U0001F44B\nIch bin 16 und habe das gebaut, weil du es sicher kennst: Video fertig, aber "
         ...
         "Captions mit starken Hooks + Hashtags. Probier's aus und sag mir ehrlich, ob's hilft: thecaptionai.com \U0001F680"),
        ("Hallo {name} \u2728\nKurze Frage an jemanden, der regelm\u00e4\u00dfig postet: Captions schreiben ist das "
         ...
         "viraler Formel + Hashtags raus. Kostenlos testen, w\u00fcrde mich \u00fcber dein Feedback freuen: thecaptionai.com"),
        ("Hey {name}! \U0001F525\nGanz direkt: dein Content ist gut, aber st\u00e4rkere Captions br\u00e4chten dir mehr "
         ...
         "Probier's, dein Feedback bedeutet mir viel: thecaptionai.com"),
    ],
    "fr": [
        ("Salut {name} \U0001F44B\nJ'ai 16 ans et j'ai cr\u00e9\u00e9 \u00e7a pour un truc que tu vis s\u00fbrement: la vid\u00e9o "
         ...
         "3s t'as 4 l\u00e9gendes avec des hooks forts + hashtags. Essaie et dis-moi franchement si \u00e7a aide: thecaptionai.com \U0001F680"),
        ("Bonjour {name} \u2728\nPetite question pour quelqu'un qui poste r\u00e9guli\u00e8rement: \u00e9crire les l\u00e9gendes "
         ...
         "4 l\u00e9gendes formule virale + hashtags. Gratuit, ton avis m'int\u00e9resse: thecaptionai.com"),
        ("Salut {name}! \U0001F525\nCash: ton contenu est bon mais des l\u00e9gendes plus percutantes te donneraient "
         ...
         "Essaie, ton retour compte beaucoup: thecaptionai.com"),
    ],
    "ar": [
...
def pick_template(lang: str, custom: dict) -> str:
    """Dile uygun varyantlardan rastgele birini seç. custom[lang] doluysa onu
    kullan (satırlar '---' ile ayrılmış birden çok varyant olabilir)."""
...
def index():
    try:
        ...
        cfg = {}
    # Her dilin varyantlarını GUI'ye '---' ile birleştirip gönder (düzenlenebilir)
...
def api_search():
    ...
    # GUI'den gelen özel şablonlar (dil -> '---' ayraçlı varyantlar)
